...
$lang->cmd_allbandazole_countries = '국가 차단';
$lang->cmd_allbandazole_clouds = '클라우드 차단';
$lang->cmd_allbandazole_heuristic = '휴리스틱 차단';
...
$lang->cmd_allbandazole_block_method_redirect = '리다이렉트';
...
$lang->cmd_allbandazole_use_heuristic_block = '휴리스틱 차단 사용';
...
$lang->msg_allbandazole_heuristic_help = '휴리스틱 차단은 의심스러운 행동을 기반으로 봇을 차단하는 기능입니다.<br />복합적인 기준을 사용하므로 개별 설정은 지원하지 않으며, 수시로 변경될 수 있습니다.<br />때때로 정상적인 방문자가 차단될 수도 있으니 캡챠나 로그인을 통해 차단을 피할 수 있는 방법을 남겨 주세요.';
...
$lang->msg_allbandazole_cloud_blocking_first = '국가 및 클라우드 차단 설정이 휴리스틱보다 우선합니다. 다른 설정에 의해 차단되지 않은 요청에 대해서만 휴리스틱을 적용합니다.';

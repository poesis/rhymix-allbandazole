...
$lang->msg_allbandazole_heuristic_help = 'Heuristic blocking is a feature that blocks bots based on suspicious behavior.<br />The actual criteria may change from time to time.<br />Legitimate visitors may sometimes be blocked. Please leave a way to bypass the block through CAPTCHA or login.';

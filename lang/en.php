...
$lang->cmd_allbandazole_heuristic = 'Heuristic Blocking';
...
$lang->cmd_allbandazole_use_heuristic_block = 'Use Heuristic Blocking';
...
$lang->msg_allbandazole_heuristic_help = 'Heuristic blocking is a feature that blocks bots based on suspicious behavior.<br />The criteria don\'t support individual configuration and may change from time to time.<br />Legitimate visitors may sometimes be blocked. Please leave a way to bypass the block through CAPTCHA or login.';
...
$lang->msg_allbandazole_cloud_blocking_first = 'Country and cloud blocking take precedence over heuristic blocking. Heuristic is applied only to requests not blocked by other settings.';
